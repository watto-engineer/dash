...
export BUILDER_IMAGE_NAME="bytz-builder-$BUILD_TARGET-$JOB_NUMBER"
...
if [ "$BUILD_TARGET" = "arm-linux" ]; then
  ...
  export CPPFLAGS="-DDEBUG_LOCKORDER -DENABLE_BYTZ_DEBUG -DARENA_DEBUG"
  export PYZMQ=true
  export RUN_UNITTESTS=true
  export RUN_INTEGRATIONTESTS=true
