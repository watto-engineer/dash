...
"""Verify that starting bytzd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bytzd with -h for help text")
        ...
        self.log.info("Start bytzd with -version for version information")
