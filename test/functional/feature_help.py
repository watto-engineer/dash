...
"""Verify that starting wagerrd with -h works as expected."""

from test_framework.test_framework import WagerrTestFramework
from test_framework.util import assert_equal

class HelpTest(WagerrTestFramework):
    ...
    def run_test(self):
        self.log.info("Start wagerrd with -h for help text")
        ...
        self.log.info("Start wagerrd with -version for version information")
        ...
        self.log.info("Start wagerrdd with -fakearg to make sure it does not start")
