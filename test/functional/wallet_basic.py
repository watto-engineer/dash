...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 210 BYTZ from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 BYTZ in block rewards plus fees, but
        ...
        # Send 100 BYTZ with subtract fee from amount
        ...
        # Sendmany 100 BYTZ with subtract fee from amount
