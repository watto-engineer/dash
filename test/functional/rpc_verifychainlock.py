...
class RPCVerifyChainLockTest(BytzTestFramework):
    def set_test_params(self):
        # -whitelist is needed to avoid the trickling logic on node0
        self.set_bytz_test_params(5, 3, [["-whitelist=127.0.0.1"], [], [], [], []], fast_dip3_enforcement=True)
        self.set_bytz_llmq_test_params(3, 2)
