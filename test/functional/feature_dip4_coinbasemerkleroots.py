...
class LLMQCoinbaseCommitmentsTest(BytzTestFramework):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as BytzTestFramework doesn't support this atm)
