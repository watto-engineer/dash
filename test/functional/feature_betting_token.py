...
class BettingTest(WagerrTestFramework):
    ...
    def check_minting(self, block_count=300):
        ...
        self.nodes[0].generate(block_count-1)
    ...
    def run_test(self):
        ...
        self.nodes[0].generate(1)
        self.sync_all()
        BETOUTADDR1=self.nodes[0].getnewaddress()
        self.nodes[0].placebet(0,1,25,BETOUTADDR1)
        breakpoint()
        self.nodes[0].generate(1)
        self.sync_all()
