...
official/supported Docker Images found at https://hub.docker.com/r/wagerr/wagerrd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/wagerr/wagerrd-develop/ when changing the above text**