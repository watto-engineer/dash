...
def build():
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/wagerrcore-*-win-unsigned.tar.gz inputs/', shell=True)
        subprocess.check_call('mv build/out/wagerrcore-*.zip build/out/wagerrcore-*.exe build/out/src/wagerrcore-*.tar.gz ../wagerrcore-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/wagerrcore-*-osx-unsigned.tar.gz inputs/', shell=True)
        subprocess.check_call('mv build/out/wagerrcore-*.tar.gz build/out/wagerrcore-*.dmg build/out/src/wagerrcore-*.tar.gz ../wagerrcore-binaries/'+args.version, shell=True)
...
def sign():
    ...
    if args.windows:
        ...
        subprocess.check_call('cp inputs/wagerrcore-' + args.version + '-win-unsigned.tar.gz inputs/wagerrcore-win-unsigned.tar.gz', shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('cp inputs/wagerrcore-' + args.version + '-osx-unsigned.tar.gz inputs/wagerrcore-osx-unsigned.tar.gz', shell=True)
