...
# Regexp to check for Wagerr addresses
...
def contains_wagerr_addr(text, errors):
    if text is not None and ADDRESS_REGEXP_DASH.search(text) is not None:
        errors.append('Translation "%s" contains a Wagerr address. This will be removed.' % (text))
        return True
    return False
        ...
        for context in root.findall('context'):
            for message in context.findall('message'):
                ...
                for translation in translations:
                    ...
                    valid = valid and not contains_wagerr_addr(translation, errors)
