...
A prefix will be generated that's suitable for plugging into Bytz's
configure. In the above example, a dir named x86_64-w64-mingw32 will be
created. To use it for Bytz:
...
options will be passed to Bytz Core's configure. In this case, `--disable-wallet`.
