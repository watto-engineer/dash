 ...
 */
void GetFieldBetPayoutsV4(const CCoinsViewCache &view, CBettingsView &bettingsViewCache, const CBlockIndex* pindexPrev, std::vector<CBetOut>& vExpectedPayouts, std::vector<CPayoutInfoDB>& vPayoutsInfo);
