...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " wagerr-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  wagerr-tx [options] <hex-tx> [commands]  Update hex-encoded wagerr transaction\n" +
            "or:     wagerr-tx [options] -create [commands]   Create hex-encoded wagerr transaction\n" +
            "\n";
