...
UniValue importaddress(const JSONRPCRequest& request)
{
    ...
    "as change, and not show up in many RPCs.\n",
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Wagerr address (or hex-encoded script)"},
...
UniValue dumpprivkey(const JSONRPCRequest& request)
{
    RPCHelpMan{"dumpprivkey",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The wagerr address for the private key"},
        },
        RPCResult{
...
UniValue dumpwallet(const JSONRPCRequest& request)
{
    RPCHelpMan{"dumpwallet",
        ...
        {
            {"filename", RPCArg::Type::STR, RPCArg::Optional::NO, "The filename with path (either absolute or relative to wagerrd)"},
        },
        RPCResult{
                RPCResult::Type::OBJ, "", "",
                {
