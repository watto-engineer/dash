...
public:
    ...
    //* Assign the groupID from a parent group and a byte vector that identifies the subgroup
    CTokenGroupID(const CTokenGroupID& tgID, const std::vector<unsigned char> subgroupData);
