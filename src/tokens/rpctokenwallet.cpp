    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
     ...
     if (request.fHelp || request.params.size() < 5)
        throw std::runtime_error(
            ...
            "\n"
            "\nExamples:\n" +
            HelpExampleCli("configuremanagementtoken", "\"GVT\" \"GuardianValidatorToken\" \"https://raw.githubusercontent.com/wagerr/ATP-descriptions/master/WAGERR-testnet-MGT.json\" 4f92d91db24bb0b8ca24a2ec86c4b012ccdc4b2e9d659c2079f5cc358413a765 039872a8730f548bc6065b2e36b0cf7691745a8783d908e0ee2cdd3279ac762b80102b0f13bd91d8582d757f58960fc1 4 false true") +
            "\n"
        );
