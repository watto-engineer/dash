    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
     ...
     if (request.fHelp || request.params.size() < 5)
        throw std::runtime_error(
            ...
            "\n"
            "\nExamples:\n" +
            HelpExampleCli("configureNFT", "\"UniquelyFun\" \"https://raw.githubusercontent.com/wagerr/ATP-descriptions/master/WAGERR-testnet-UniquelyFun.json\" 4f92d91db24bb0b8ca24a2ec86c4b012ccdc4b2e9d659c2079f5cc358413a765 VGhpcyB0b2tlbiBpcyB1bmlxdWUgYW5kIGZ1bi4= true") +
            "\n"
        );
