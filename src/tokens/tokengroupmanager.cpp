...
void CTokenGroupManager::ResetTokenGroups() {
    ...
    std::shared_ptr<CTokenGroupDescriptionRegular> tgDescriptionWAGERR = std::make_shared<CTokenGroupDescriptionRegular>("WAGERR", "Wagerr", 8, "https://wagerr.com", uint256());
