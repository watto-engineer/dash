...
void SendCoinsDialog::send(QList<SendCoinsRecipient> recipients)
{
    ...
    if (m_coin_control->IsUsingCoinJoin()) {
        ...
        if (nInputs >= 10 && m_coin_control->IsUsingCoinJoin()) {
            ...
            questionString.append("<a style='" + GUIUtil::getThemedStyleQString(GUIUtil::ThemedStyle::TS_COMMAND) + "' href=\"https://docs.wagerr.org/en/stable/wallets/wagerrcore/coinjoin-instantsend.html#inputs\">");
