...
//
//     src/qt/test/test_bytz-qt -platform xcb      # Linux
//     src/qt/test/test_bytz-qt -platform windows  # Windows
//     src/qt/test/test_bytz-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: bytz:")) != -1);
