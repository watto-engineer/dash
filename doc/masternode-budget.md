...
Format: ```mngovernance prepare proposal-name url payment-count block-start bytz-address monthly-payment-bytz```
...
Format: ```mngovernance submit proposal-name url payment-count block-start bytz-address monthly-payment-bytz fee-tx```
...
When block ```1000000``` is reached you'll receive a payment for ```1200``` BYTZ to ```y6R9oN12KnB9zydzTLc3LikD9cCjjQzYG7```.
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using bytz.conf setup)
