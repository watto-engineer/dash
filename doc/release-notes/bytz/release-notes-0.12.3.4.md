...
When deployed on testnet, it is required to start with a fresh data directory or call Bytz Core with `-reindex-chainstate`.

0.12.3.4 Change log
===================

See detailed [set of changes](https://github.com/bytzcurrency/bytz/compare/v0.12.3.3...bytzcurrency:v0.12.3.4).
