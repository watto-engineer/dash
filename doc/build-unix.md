UNIX BUILD NOTES
====================
Some notes on how to build Wagerr Core in Unix.
...
-----------------------
Building the dependencies and Wagerr Core requires some essential build tools and libraries to be installed before.
...
Security
--------
To help make your Wagerr Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Wagerr Core should be built with a non-executable stack,
