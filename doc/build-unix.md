UNIX BUILD NOTES
====================
Some notes on how to build Bytz Core in Unix.
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, Bytz Core should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, Bytz Core may be compiled in
