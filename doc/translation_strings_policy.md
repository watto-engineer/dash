...
This document provides guidelines for internationalization of the Bytz Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bytz_en.ts` remains unchanged.
